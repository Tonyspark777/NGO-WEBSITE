...
export default function About({ onNavigate }: AboutProps = {}) {
  const leaders = [
    { name: 'Frank Eze', title: 'Founder & Executive Director', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68cbc888df1576afba05c1c7/93d272f2c_Frank.jpg' },
    { name: 'Chimdindu Eze', title: 'Treasurer (Finance & Audit)', img: '/chimdindu_eze.png' },
